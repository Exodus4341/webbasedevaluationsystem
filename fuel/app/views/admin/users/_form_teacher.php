<?php echo Form::open(array('method' => 'post', 'enctype' => 'multipart/form-data')); ?>
	...
	<table>
		...
		<tr>
			<th><?php echo Form::label('First name', 'fname'); ?></th>
			<th><div class="clearfix">
			<div class="input">
		...
		<tr>
			<th><?php echo Form::label('Last name', 'lname'); ?></th>
			<th><div class="clearfix">
			<div class="input">
		...
		<tr>
			<th><?php echo Form::label('Middle name', 'mname'); ?></th>
			<th><div class="clearfix">
			<div class="input">
		...
		<tr>
			<th><?php echo Form::label('Department', 'department'); ?></th>
			<th><div class="clearfix">
			<div class="input">
				<?php echo Form::select('id', Input::post('id', isset($user) ? $user->department : $current_user->id), $departments, array('class' => 'span4')); ?>
			</div>
			</div></th>
		</tr>
		<tr>
		...
		<tr>
			...
			<th><div class="clearfix">
			<div class="input">
				<?php echo Form::select('group', Input::post('group', isset($user) ? $user->group : ''), array(50=>'teacher'), array('class' => 'span4')); ?>
			</div>
			</div></th>
		</tr>
	</table>
