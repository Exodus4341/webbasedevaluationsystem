...
<?php echo Form::open(array()); ?>
	...
	<div class="box">
		...
		<table>
			...
			<tr>
				<div class="row">
					<th><div class="input-group"><?php echo Form::input('email', Input::post('email'), array('placeholder' => 'Email or Username', 'class' => 'form-control')); ?></div></th>
			...
			<tr>
				<div class="row">
					<th><div class="input-group"><?php echo Form::password('password', Input::post(''), array('placeholder' => 'Password', 'class' => 'form-control')); ?></div></th>
