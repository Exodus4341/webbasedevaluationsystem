...
<div align="center">
	<div class="box" >
		...
		<table>
			<tr>
				<th><?php echo Asset::img('teacher-edited.png', array('style' => 'width:170px; height:170px; border-radius:50%; border: 2px solid #1b1b1b;')); ?></th>
			</tr>
			<tr>
				<th><h2>Teacher</h2></th>
			</tr>
			...
			<tr>
				<div class="row">
					<th><div class="input"><?php echo Form::password('password', Input::post('email'), array('placeholder' => 'Password')); ?></div></th>
